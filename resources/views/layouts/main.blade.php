        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('show_all_articles') || request()->routeIs('show_article') || request()->routeIs('get_articles_by_tag') ? 'active' : '' }}" href="{{ route('show_all_articles') }}">Catalog</a></li>
                </ul>
            </div>
        </div>
    </nav>
